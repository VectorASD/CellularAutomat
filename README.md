...
- space - вверх
- left ctrl - вниз
- left shift - 3x баф к скорости

- Клик по экрану ЛКМ - переход из режима кликов в режим вращения камеры.
- Важно! Программа разрабатывалась в эмуляторе, где есть прикол в захватом курсора мыши! В гостевой машине захват работает как надо, а вот в хостовой - нопь! Это приводит к тому, что у вас не будет крутиться до конца камера из-за того, что хостовой курсор упирается в край экрана и это НЕ возможно пофиксить для виртуалок! Также у Hyper-V есть плохое свойсво увеличивать чувствительность в 20 раз (чем не грешит вируал бокс). Так что если у вас не виртуалка, подкрутите чувствительность в первой функции context.c файла, а именно camera->sensitivity из 0.2 сделайте 4, либо по усмотрению на ваш вкус.
